...
mixin _$ChatScreenState {
  ...
  String get firebaseChatDocumentName;
  List<ChatMessageDomain> get messages;
  DocumentSnapshot? get lastDocument;
  bool get hasMore;
  String? get chatContent;
  List<XFile>? get imageFiles;
  List<XFile>? get videoFiles;
  List<XFile>? get otherFiles;
  JoyUser? get currentUser;
  ...
  $ChatScreenStateCopyWith<ChatScreenState> get copyWith =>
      _$ChatScreenStateCopyWithImpl<ChatScreenState>(
          this as ChatScreenState, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ChatScreenState &&
            ...
            (identical(
                    other.firebaseChatDocumentName, firebaseChatDocumentName) ||
                other.firebaseChatDocumentName == firebaseChatDocumentName) &&
            ...
            const DeepCollectionEquality()
                .equals(other.otherFiles, otherFiles) &&
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(otherFiles),
      currentUser);
...
abstract mixin class $ChatScreenStateCopyWith<$Res> {
  factory $ChatScreenStateCopyWith(
          ChatScreenState value, $Res Function(ChatScreenState) _then) =
      _$ChatScreenStateCopyWithImpl;
  @useResult
  $Res call(
      {bool isLoading,
      String? messageKey,
      String chatTitle,
      String firebaseChatDocumentName,
      List<ChatMessageDomain> messages,
      DocumentSnapshot? lastDocument,
      bool hasMore,
      String? chatContent,
      List<XFile>? imageFiles,
      List<XFile>? videoFiles,
      List<XFile>? otherFiles,
      JoyUser? currentUser});
...
class _$ChatScreenStateCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    Object? firebaseChatDocumentName = null,
    ...
    return _then(_self.copyWith(
      ...
      chatTitle: null == chatTitle
          ...
          : chatTitle // ignore: cast_nullable_to_non_nullable
              as String,
      firebaseChatDocumentName: null == firebaseChatDocumentName
          ? _self.firebaseChatDocumentName
          : firebaseChatDocumentName // ignore: cast_nullable_to_non_nullable
              as String,
      messages: null == messages
          ? _self.messages
          : messages // ignore: cast_nullable_to_non_nullable
              as List<ChatMessageDomain>,
      ...
      videoFiles: freezed == videoFiles
          ...
          : videoFiles // ignore: cast_nullable_to_non_nullable
              as List<XFile>?,
      otherFiles: freezed == otherFiles
          ? _self.otherFiles
          : otherFiles // ignore: cast_nullable_to_non_nullable
              as List<XFile>?,
...
class _ChatScreenState implements ChatScreenState {
  const _ChatScreenState(
      ...
      required this.firebaseChatDocumentName,
      required final List<ChatMessageDomain> messages,
      required this.lastDocument,
      required this.hasMore,
      required this.chatContent,
      required final List<XFile>? imageFiles,
      required final List<XFile>? videoFiles,
      required final List<XFile>? otherFiles,
      this.currentUser})
      : _messages = messages,
  ...
  @override
  final String firebaseChatDocumentName;
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ChatScreenStateCopyWith<_ChatScreenState> get copyWith =>
      __$ChatScreenStateCopyWithImpl<_ChatScreenState>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ChatScreenState &&
            (identical(other.isLoading, isLoading) ||
                other.isLoading == isLoading) &&
            (identical(other.messageKey, messageKey) ||
                other.messageKey == messageKey) &&
            ...
            const DeepCollectionEquality()
                .equals(other._otherFiles, _otherFiles) &&
            (identical(other.currentUser, currentUser) ||
                other.currentUser == currentUser));
  }
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(_otherFiles),
      currentUser);
...
/// @nodoc
abstract mixin class _$ChatScreenStateCopyWith<$Res>
    implements $ChatScreenStateCopyWith<$Res> {
  factory _$ChatScreenStateCopyWith(
          _ChatScreenState value, $Res Function(_ChatScreenState) _then) =
      __$ChatScreenStateCopyWithImpl;
  @override
  @useResult
  $Res call(
      {bool isLoading,
